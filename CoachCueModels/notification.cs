    ...
    public partial class notification 
    {
        ...
        public LinkData linkData
        {
            get
            {
                ...
                {
                    case "matchupMessage":
                        matchup match = matchup.Get(this.entityID.Value);
                        if (match != null)
                        {
                            link.Message = match.nflplayer.fullName + " vs " + match.nflplayer1.fullName;
                            link.ID = match.matchupID;
                        }
                        break;
                    case "voteMatchup":
            ...
            get
            {
                ...
                switch (this.notification_type.type)
                {
                    ...
                    case "messageMention":
                        ...
                        break;
                    case "matchupMessage":
                        msg = " has commented on your matchup ";
                        break;
                }
        ...
        public static LinkData GetMentionLink(int messageID, string guid)
        {
            LinkData link = new LinkData();
                    ...
                    if (changeViewed)
                    {
                        foreach (notification notice in notifications)
                        {
                            if (notice.status.statusName != "Viewed")
                            {
                                ...
                                updateNotice.dateUpdated = DateTime.UtcNow.GetEasternTime();
