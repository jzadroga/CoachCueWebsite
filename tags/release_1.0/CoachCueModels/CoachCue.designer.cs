...
namespace CoachCue.Model
{
    ...
    partial void OnyearsExperienceChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="nflplayer_message", Storage="_messages", ThisKey="playerID", OtherKey="playerID")]
    ...
    partial void OnplayerIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="nflplayer_message", Storage="_nflplayer", ThisKey="playerID", OtherKey="playerID", IsForeignKey=true)]
		public nflplayer nflplayer
		{
			get
			{
