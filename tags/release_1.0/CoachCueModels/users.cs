    ...
    public partial class user
    {
            ...
            get
            {
                ...
                if (this.user_logins != null)
                {
                    if (this.user_logins.Count() > 0)
                    {
                        ...
                        DateTime eastTime = TimeZoneInfo.ConvertTimeFromUtc(loginDate, easterZone);

                        last = eastTime.ToShortDateString() + " " + eastTime.ToShortTimeString();
                    }
                }
                return last;
            }
        ...
        public string DateRegistered
        {
            get
            {
                ...
                TimeZoneInfo easterZone = TimeZoneInfo.FindSystemTimeZoneById("Eastern Standard Time");
                DateTime eastTime = TimeZoneInfo.ConvertTimeFromUtc(this.dateCreated.Value, easterZone);
        ...
        public static int FollowersCount(int userID)
        {
            int count = 0;
        ...
        public static int GetFollowingPlayerCount(int userID)
        {
            CoachCueDataContext db = new CoachCueDataContext();
            int count = 0;
        ...
        public static bool IsValidUser(string username, string password)
        {
            ...
            try
            {
                ...
                if (userItem != null)
                {
                    ...
                    coachCueCookie.Expires = DateTime.Now.AddYears(3);
        ...
        public static int GetUserID(string email)
        {
            ...
            try
            {
                if (HttpContext.Current.Session["UserID"] != null)
                    userID = (!string.IsNullOrEmpty( HttpContext.Current.Session["UserID"].ToString()) ) ? Convert.ToInt32( HttpContext.Current.Session["UserID"].ToString()) : 0;
        ...
        public static UserVoteData AddMatchup(int userID, int playerID, int matchupID)
        {
            ...
            try
            {
                ...
                if( db.users_matchups.Where( um => um.userID == userID && um.matchupID == matchupID ).Count() > 0 )
                {
                ...
                else
                {
                    ...
                    WeeklyMatchups weeklyMatchupItem = matchup.GetWeeklyMatchup(matchupItem, false);
        ...
        public static WeeklyMatchups AddStreamSelectedMatchup(int userID, int playerID, int matchupID)
        {
            ...
            try
            {
                ...
                matchupChoice = matchup.GetWeeklyMatchup(matchup.Get(matchupID), false, userID);
            }
            catch (Exception) { }
        ...
        public static List<LeaderboardCoach> GetTopCoachesByWeek(int number, int week)
        {
            ...
            try
            {
                ...
                foreach (user coach in coaches)
                {
                    if (coach.users_matchups != null)
                    {
                        ...
                        {
                            var weeklyMatchups = coach.users_matchups.Where(us => us.matchup.gameschedule1.weekNumber == week && us.matchup.status.statusName != "Deleted" && (us.correctMatchup == true || us.correctMatchup == false));
                            if (weeklyMatchups != null)
                            {
            ...
            return topCoaches.OrderByDescending( ch => ch.Percent ).Take(number).ToList();
        }
