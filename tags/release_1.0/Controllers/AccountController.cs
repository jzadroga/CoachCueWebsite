...
namespace CoachCue.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public ActionResult Login(string username, string passwrd, string rememberMe, string returnUrl)
        {
            ...
            ViewData["valid"] = "Email Address and/or Password is invalid";
            return View();
        }
        ...
        public ActionResult Following()
        {
            ...
            fvm.TrendingItems = user.GetAccountsFromPlayers(nflplayer.GetTrending(15), (userID != 0) ? (int?)userID : null);
        ...
        public ActionResult Notifications()
        {
            ...
            int userID = (User.Identity.IsAuthenticated) ? user.GetUserID(User.Identity.Name) : 0;
            notVM.TrendingItems = user.GetAccountsFromPlayers(nflplayer.GetTrending(15), (userID != 0) ? (int?)userID : null);
        ...
        public ActionResult UpdateProfileBasic(ProfileViewModel basicProfile)
        {
            ...
            if (ModelState.IsValid)
            {
                success = user.UpdateProfile(userItem.userID, basicProfile.FullName, basicProfile.Email, basicProfile.UserName);
            }
