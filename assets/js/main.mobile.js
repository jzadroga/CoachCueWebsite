...
$(document).on("pageinit", function () {
    ...
    $(".follow").on('click', function (event, ui) {
        ...
        $(this).removeClass("btn-success follow").addClass("btn-danger unfollow").html("Unfollow");
        return false;
    });
    ...
    $(".unfollow").on('click', function (event, ui) {
        ...
        $(this).removeClass("btn-danger unfollow").addClass("btn-success follow").html("Follow");
        return false;
    });
    ...
    $('#player1, #player2, .new-matchup-input').typeahead({
        ...
        render: function (items) {
            ...
            items = $(items).map(function (i, item) {
                ...
                i.find('a').html('<img class="typeahead-avatar" src="' + playerData[4] + '" alt=""><span class="typeahead-bio">' + that.highlighter(item) + '</span>');
                return i[0]
            })
