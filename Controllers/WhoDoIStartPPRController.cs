...
{
    public class WhoDoIStartPPRController : BaseController
    {
        public async Task<ActionResult> Index(string week, string players)
        {
            ...
            myMatchVM.Matchup = await StreamService.GetDetailStream(myMatchVM.UserData, "whodoistartppr/" + week + "/" + players);
